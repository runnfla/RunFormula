# RunFormula
The RunFormula is a module for FreePascal and Lazarus intended to evaluate mathematical expressions and physics formulas provided as text with scripting language support and physical dimension handling.
